    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3">
        {hosts.map((h, i) => (
          ...
          >
            <p className="font-rb-mono text-[0.6rem] tracking-[0.18em] uppercase text-[#635C4B] mb-5">
              0{i + 1} / Host
            </p>
            ...
            <p className="font-rb-sans text-[0.88rem] text-[#635C4B] leading-[1.75] mb-6 whitespace-pre-line">
              {h.bio}
            </p>
            <dl className="border-t border-[rgba(28,61,42,0.15)]">
              <div className="flex justify-between py-2.5 border-b border-[rgba(28,61,42,0.15)]">
                <dt className="font-rb-mono text-[0.58rem] tracking-[0.1em] uppercase text-[#635C4B]">
                  Thuisbaan
                </dt>
